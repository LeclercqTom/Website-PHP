    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                <form class="login" action="create" method="POST" name="forminscription">
                    <div class="login__field">
                        <i class="login__icon fas fa-user"></i>
                        <input type="text" class="login__input" placeholder="Lastname" name="name">
                        <input type="text" class="login__input" placeholder="Firstname" name="firstname">
                    </div>
                    <div class="login__field">
                        <i class="login__icon fas fa-envelope"></i>
                        <input type="text" class="login__input" placeholder="Email" name="mail">
                    </div>
                    <div class="login__field">
                        <i class="login__icon fas fa-lock"></i>
                        <input type="password" class="login__input" placeholder="Password" name="password">
                        <input type="password" class="login__input" placeholder="Comfirm password" name="password2">
                    </div>
...
if (isset($_GET['erreur'])) {
    ...
    if ($err == 2)
        echo "<p style='color:red'>Votre adresse mail n'est pas valide !</p>";
    if ($err == 3)
